    ...
    <div class="panel rt">
      <form id="form-register" method="post" action="">
        ...
        <div class="form-group">
          ...
          <span id="uname_hint" class="msg-default">用户名长度在6到9位之间</span>
        </div>
        <div class="form-group">
...
<script>
  $('#bt-register').click(function(){
    ...
    if(lengths==5){
       $.ajax({
    	   "url":"handle_reg.do",
    	   "data":"username="+$("#uname").val()+"&password="+$("#upwd").val()+"&phone="+$("#phone").val()+"&email="+$("#email").val(),
    	   "type":"post",
    	   "dataType":"json",
  ...
  uname.onblur = function(){
    if(this.validity.valueMissing){
      ...
      $.ajax({
    	  ...
    	  "dataType":"json",
    	  "success":function(obj){
    		   $("#uname_hint").html("用户名"+obj.message);
    		    if(obj.state==0){
    		    	$("#uname_hint").attr("class","msg-success");
    		    }else{
    		    	$("#uname_hint").attr("class","msg-error");
    		    }
    	  }
      });
     }
  ...
  email.onblur = function(){
    if(this.validity.valueMissing){
      ...
      /**发起异步GET请求，询问服务器邮箱是否已经存在**/
    	  ...
    	  "dataType":"json",
    	  "success":function(obj){
    		   $("#email_hint").html("邮箱"+obj.message);
    		    if(obj.state==0){
  ...
  phone.onblur = function(){
    if(this.validity.valueMissing){
      ...
      /**发起异步GET请求，询问服务器用户名是否已经存在**/
    	  ...
    	  "dataType":"json",
    	  "success":function(obj){
    		   $("#phone_hint").html("手机号"+obj.message);
    		    if(obj.state==0){
