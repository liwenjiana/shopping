    ...
    <div class="adress_choice">
        ...
        <div id="addresId1" class="base_select">
            ...
            <i class="user_address">
                ${addr.recvAddr}   ${addr.recvTel}
            </i>
            <i class='user_site rt <c:if test="${addr.isDefault==1 }">default</c:if>'>
                设为默认地址
            </i>
            ...
            <ul class="item_detail">
                <li class="p_info">
                    ...
                    <b class="product_name lf">
                        ${cart.goodsTitle}
                        <input type="hidden"  name="goods_title" value="${cart.goodsTitle}">
                    </b>
                    <br/>
                ...
                <li class="p_price">
                    ...
                    <span class="pro_price">￥<span class="ppp_price">${cart.goodsPrice}.00</span></span>
                     <input type="hidden"  name="goods_price" value="${cart.goodsPrice}">
                     <input type="hidden"  name="goods_count" value="${cart.goodsCount}"/>
                </li>
