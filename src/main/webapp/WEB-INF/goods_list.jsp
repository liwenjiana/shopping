			...
			<section id="section">
				...
				<div id="wrap">
				   <c:forEach items="${goods}" var="good">
					...
					<div class="lf box" id="d1"  style="width:230px;height:224px">
						<div class="info">
						<div class="img pic">
							<img src="${pageContext.request.contextPath}${good.image}" alt="" onclick="getDetail(${good.id})" />
						</div>			
						<div class="describe">
							<p onclick="toItemInfo(${good.id})">${good.title}</p>
							<span class="price"><b>￥</b><span class="priceContent">${good.price}.00</span></span>
				    ...
				    <div id="pages">
					     ...
					     <c:forEach begin="1" end="${pageNum}" var="i">
					            <li><a   
					                        ...
					                        href="list.do?category_id=${categoryId}&order_by=0&&page=${i}"
					                     >${i}</a></li>
					     </c:forEach>	
					     </ul>
					     <span>共查到商品${count}条</span>
					</div>
					</div>
