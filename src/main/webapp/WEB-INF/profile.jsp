    ...
    <div class="rightsidebar_box rt">
        ...
        <div class="rs_content">
            ...
            <div class="rs_content_username">
                ...
                <input  id=""  name="username" class="ed_username"  style="display: none;" value="${user.username}"/>
                <span class="change_username same_click">更改用户名</span>
            </div>
            <!--性别-->
            <div class="rs_content_sex">
                <span class="same">性别：</span>
                <input  id=""  name="gender"  type="radio" value="1" 
                             <c:if test="${user.gender==1}">checked="checked"</c:if>
                />男
                 <input  id=""  name="gender"  type="radio" value="0"
            ...
            <div class="rs_content_tel">
                ...
                <input  id=""  name="phone"  type="text" value="${user.phone}"/>
            </div>
            <!--绑定邮箱-->
            <div class="rs_content_mail">
                <span class="same">绑定邮箱：</span>
                <input  id=""  name="email"  class="ed_email"  style="display: none;"/>
                <span class="rs_mail">${user.email}</span>
                <span class="same_click change_mail">更改邮箱</span>
            </div>
            <!--保存按钮-->
            <div class="save">
                <a class="save" onclick="save()">保存更改</a>
            </div>
           </form> 
        </div>
    </div>
