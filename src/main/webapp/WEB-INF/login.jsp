...
<div id="container">
    <div id="cover" class="rt">
        <form id="login-form" method="post" name="form1">
            <div class="txt">
                <p>
					登录学子商城<span><a href="regists.do">新用户注册</a></span>
                </p>
                <div class="text">
                ...
                <div class="text">
                    <input type="hidden" id="hiddenYZM" value="${yzm }"/>
                    <input type="text" id="yzm" placeholder="请输入验证码" name="yzm" required minlength="6" maxlength="15">
                    <span><img src="png.do"  id="yzmPng"  style="top: -37px;right: -180px" onclick="changImg()"></span>
                </div>
                <div class="chose">
...
function changImg(){
	console.log("11");
	$("#yzmPng").attr("src","png.do?id="+Math.random());
}
</script>
</body>
</html>