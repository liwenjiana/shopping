   ...
   <!-- 右边栏-->
    <div class="rightsidebar_box rt">	
        ...
        <!--收货人信息填写栏-->
            ...
            <div id="popup_content" class="rs_content" >
	        	<form method="post" action="">
		            ...
		            <!--保存收货人信息-->
		            <div class="save_recipient" onclick="show()">
		                保存收货人信息
		            </div>
	    		</form>
    		</div>
            ...
            <div class="address_information_manage"  >
                ...
                <div><a  class="button_blue" onclick="showPopup()" href="#">新增收货地址</a></div>
            </div>
         ...
         $.ajax({
        	 ...
        	 "success":function(obj){
        		   ...
        		   for(var i=0;i<addrs.length;i++){ 			     
        			   addressString+= '<div class="aim_content_one aim_active">'
        			    	    	 +' <span class="dzmc dzmc_normal">'+addrs[i].recvTag+'</span>'
        			    	    	 +' <span class="dzxm dzxm_normal">'+addrs[i].recvName+'</span>'
        			    	    	 +'<span class="dzxq dzxq_normal">'+addrs[i].recvAddr+'</span>'
        			    	    	 +' <span class="lxdh lxdh_normal">'+addrs[i].recvTel+'</span>'
        			    	    	 +'<span class="operation operation_normal">'
        			    	    	 +'<span class="aco_change">修改</span>|<span class="aco_delete">删除</span>'
        			    	    	 +'</span>'
        			    	    	 +'<span class="swmr swmr_normal"></span>'
        		   ...
        		   $("#addresslist").html(addressString);
        	 }
         });
     });
